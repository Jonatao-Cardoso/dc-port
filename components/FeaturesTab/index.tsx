...
const FeaturesTab = () => {
  ...
  return (
    <>
      {/* <!-- ===== Features Tab Start ===== --> */}
      <section id="sucess" className="relative pb-20 pt-18.5 lg:pb-22.5 space-y-10">
      <SectionHeader
            headerInfo={{
              title: "💯",
              subtitle: "Casos de Sucesso",
              description: `Conheça histórias reais de clientes que transformaram seus negócios conosco.
              Resultados concretos com soluções de tecnologia e automação sob medida.
              Sucesso que inspira, parceria que gera impacto.`,
            }}
          />
